...
from imodels import GreedyTreeClassifier, GreedyTreeRegressor, C45TreeClassifier, FIGSClassifier
...
#     [ModelConfig('FIGS_(Include_Linear)', FIGSClassifier, 'max_rules', n, {'include_linear': True})
#      for n in cat((np.arange(1, 19, 3), [25, 30]))],
#     [ModelConfig('FIGS_(Reweighted)', FIGSClassifier, 'max_rules', n, {'posthoc_ridge': True})
#      for n in cat((np.arange(1, 19, 3), [25, 30]))],    
]
