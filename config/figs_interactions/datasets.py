DATASETS_CLASSIFICATION = [
    # classification dataset from original random forests paper
    ...
    #
    # # popular classification dataset used in rule-based modeling / fairness
    ...
    ("enhancer", "enhancer", "imodels")
]

DATASETS_REGRESSION = [
    # leo-breiman paper random forest uses some UCI dataset as well
