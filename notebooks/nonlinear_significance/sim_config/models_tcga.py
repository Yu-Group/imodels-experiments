...
ESTIMATORS = [
    ...
    [ModelConfig('RF_ntree1000_min5', RandomForestRegressor, other_params={'n_estimators': 1000, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree500_min5', RandomForestRegressor, other_params={'n_estimators': 500, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree100_min5', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree1000_min1', RandomForestRegressor, other_params={'n_estimators': 1000, 'min_samples_leaf': 1, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree500_min1', RandomForestRegressor, other_params={'n_estimators': 500, 'min_samples_leaf': 1, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree100_min1', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 1, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree1000_min10', RandomForestRegressor, other_params={'n_estimators': 1000, 'min_samples_leaf': 10, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree500_min10', RandomForestRegressor, other_params={'n_estimators': 500, 'min_samples_leaf': 10, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree100_min10', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 10, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree1000_min20', RandomForestRegressor, other_params={'n_estimators': 1000, 'min_samples_leaf': 20, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree500_min20', RandomForestRegressor, other_params={'n_estimators': 500, 'min_samples_leaf': 20, 'max_features': 0.33}, model_type='tree')],
    [ModelConfig('RF_ntree100_min20', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 20, 'max_features': 0.33}, model_type='tree')],
