...
ESTIMATORS = [
    ...
    # [ModelConfig('RF50', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
    # [ModelConfig('RF100', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
    # [ModelConfig('RF500', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
    # [ModelConfig('RF1000', RandomForestRegressor, other_params={'n_estimators': 100, 'min_samples_leaf': 5, 'max_features': 0.33}, model_type='tree')],
...
FI_ESTIMATORS = [
    ...
    [FIModelConfig('r2f (CV_frac)', tree_feature_significance, None, True, model_type='tree', other_params={'type': 'lasso', 'max_components_type': 'minfracnp', 'fraction_chosen': 0.5, 'criteria': 'cv', 'refit': True})],
