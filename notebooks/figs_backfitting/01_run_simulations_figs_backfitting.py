...
from imodels.experimental import FIGSExtRegressor
...
figs_params = {"min_impurity_decrease": thres * sigma ** 2,
               "k1": 10}

model_dict = {"GAM": LinearGAM(gam_terms),
              "CART": DecisionTreeRegressor(min_samples_leaf=5),
              "RF": RandomForestRegressor(),
              "FIGS": FIGSExtRegressor(min_impurity_decrease=thres*sigma**2),
              "FIGS+": FIGSExtRegressor(**figs_params),
              "XGB": XGBRegressor()}
