    ...
    for model in estimators:
        ...
        for splitting_strategy, fi_ests in fi_ests_dict.items():
            ...
            for fi_est in tqdm(fi_ests):
                ...
                local_fi_score_train, _ = fi_est.cls(X_train=X_train, y_train=y_train, X_test=X_test, model=loaded_model, absolute=True)
                ...
                if sklearn.base.is_classifier(est):
                    ...
                    for keep_ratio in keep_ratio_list:
                        ...
                        for a_model in ablation_models:
                            ...
                            metric_results[f'{a_model}_R2_keep_{keep_ratio}'] = r2_score(y_test, y_pred)
