...
FI_ESTIMATORS = [
    ...
    #[FIModelConfig('Local_MDI+_MDI_ridge_fit_on_all_RFPlus', LFI_evaluation_MDIRFPlus_all_retrain, model_type='tree', base_model="RFPlus_ridge", splitting_strategy = "train-test")],
]