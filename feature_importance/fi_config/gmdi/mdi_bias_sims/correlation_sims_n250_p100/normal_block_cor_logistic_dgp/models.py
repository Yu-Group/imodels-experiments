...
ESTIMATORS = [
    [ModelConfig('RF', RandomForestClassifier, model_type='tree',
                 other_params={'n_estimators': 100, 'min_samples_leaf': 1, 'max_features': 'sqrt', 'random_state': 21})],
]

FI_ESTIMATORS = [
    #[FIModelConfig('GMDI_logistic_auroc', GMDI_pipeline, model_type='tree', other_params = {'regression': False})],
    [FIModelConfig('GMDI_logistic_logloss_always_include_raw', GMDI_pipeline, model_type='tree', ascending=False, other_params = {'regression': False, 'scoring_fn': log_loss,"drop_features":False})],
    [FIModelConfig('GMDI_ridge_always_include_raw', GMDI_pipeline, model_type='tree', other_params = {'regression': False, 'partial_prediction_model': RidgeLOOPPM(), 'scoring_fn': r2_score,"drop_features": False})],
