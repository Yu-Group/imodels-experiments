...
FI_ESTIMATORS = [
    ...
    [FIModelConfig('Local_MDI+_Alo_fit_on_all_ranking_RFPlus', LFI_evaluation_AloRFPlus_all_ranking_retrain, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test")],
    [FIModelConfig('Local_MDI+_MDI_fit_on_all_ranking_RFPlus', LFI_evaluation_MDIRFPlus_all_ranking_retrain, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test")],
    ...
    [FIModelConfig('Local_MDI+_Alo_fit_on_all_RFPlus', LFI_evaluation_AloRFPlus_all_retrain, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test")],
]
