...
ESTIMATORS = [
    [ModelConfig('RF', RandomForestClassifier, model_type='',
...
FI_ESTIMATORS = [
    ...
    [FIModelConfig('LFI_with_raw_RF_plus', LFI_evaluation_RF_plus, model_type='tree', splitting_strategy = "train-test")],
