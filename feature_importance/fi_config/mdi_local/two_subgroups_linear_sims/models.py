...
FI_ESTIMATORS = [
    ...
    [FIModelConfig('LFI_sum_absolute', LFI_sum_absolute, model_type='tree')],
    [FIModelConfig('LFI_absolute_sum', LFI_absolute_sum, model_type='tree')],
    ...
    [FIModelConfig('LFI_sum_absolute_without_raw', LFI_sum_absolute, model_type='tree', other_params={"include_raw": False})],
    [FIModelConfig('LFI_absolute_sum_without_raw', LFI_absolute_sum, model_type='tree', other_params={"include_raw": False})],
