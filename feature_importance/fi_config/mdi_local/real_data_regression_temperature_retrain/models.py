...
FI_ESTIMATORS = [
    ...
    # [FIModelConfig('Local_MDI+_fit_on_inbag_error_metric_RFPlus', LFI_evaluation_RFPlus_inbag_error_metric_retrain, model_type='tree', base_model="RFPlus_inbag", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_oob_error_metric_RFPlus', LFI_evaluation_RFPlus_oob_error_metric_retrain, model_type='tree', base_model="RFPlus_oob", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_all_error_metric_RFPlus', LFI_evaluation_RFPlus_all_error_metric_retrain, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_inbag_error_metric_average_RFPlus', LFI_evaluation_RFPlus_inbag_error_metric_average_retrain, model_type='tree', base_model="RFPlus_inbag", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_oob_error_metric_average_RFPlus', LFI_evaluation_RFPlus_oob_error_metric_average_retrain, model_type='tree', base_model="RFPlus_oob", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_all_error_metric_average_RFPlus', LFI_evaluation_RFPlus_all_error_metric_average_retrain, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_inbag_error_metric_ranking_RFPlus', LFI_evaluation_RFPlus_inbag_error_metric_ranking_retrain, model_type='tree', base_model="RFPlus_inbag", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_oob_error_metric_ranking_RFPlus', LFI_evaluation_RFPlus_oob_error_metric_ranking_retrain, model_type='tree', base_model="RFPlus_oob", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_all_error_metric_ranking_RFPlus', LFI_evaluation_RFPlus_all_error_metric_ranking_retrain, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test")],
    ...
    # [FIModelConfig('Local_MDI+_fit_on_inbag_ranking_ridge_RFPlus', LFI_evaluation_RFPlus_inbag_ranking_ridge_retrain, model_type='tree', base_model="RFPlus_inbag_ridge", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_oob_ranking_ridge_RFPlus', LFI_evaluation_RFPlus_oob_ranking_ridge_retrain, model_type='tree', base_model="RFPlus_oob_ridge", splitting_strategy = "train-test")],
    # [FIModelConfig('Local_MDI+_fit_on_all_ranking_ridge_RFPlus', LFI_evaluation_RFPlus_all_ranking_ridge_retrain, model_type='tree', base_model="RFPlus_ridge", splitting_strategy = "train-test")],
