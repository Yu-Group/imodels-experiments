...
FI_ESTIMATORS = [
    ...
    [FIModelConfig('Local_MDI+_fit_on_all_evaluate_on_all_RFPlus_error_metric', LFI_evaluation_RFPlus_all_error_metric, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test", ascending=False)],
    [FIModelConfig('Local_MDI+_fit_on_all_evaluate_on_oob_RFPlus_error_metric', LFI_evaluation_RFPlus_oob_error_metric, model_type='tree', base_model="RFPlus_default", splitting_strategy = "train-test", ascending=False)],
