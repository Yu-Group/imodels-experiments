...
view_results <- function(metrics_plt_ls, tpr_plt_ls = list()) {
...
for (results_subdir in list.dirs(results_dir, full.names = TRUE, recursive = FALSE)) {
  if (stringr::str_detect(basename(results_subdir), "omitted|algorithmic_choices|sparsity_sims")) {
    next
  }
...
view_results(metrics_plt_ls, tpr_plt_ls)
rm(tpr_plt_ls)
