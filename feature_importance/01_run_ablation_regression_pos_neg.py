            ...
            for fi_est in tqdm(fi_ests):
                ...
                for ablation_data in ablation_datas:
                    ...
                    if not isinstance(local_fi_score_data, np.ndarray):
                        for a_model in ablation_models:
                            metric_results[a_model + f'_{ablation_data}_MSE_before_ablation_positive'] = None
                            metric_results[a_model + f'_{ablation_data}_R_2_before_ablation_positive'] = None
                            ###
                            metric_results[a_model + f'_{ablation_data}_mean_y_pred_before_ablation_positive'] = None
                            ###
                        for i in range(num_ablate_features):
                            for a_model in ablation_models:
                                metric_results[f'{a_model}_{ablation_data}_MSE_after_ablation_{i+1}_positive'] = None
                                metric_results[f'{a_model}_{ablation_data}_R_2_after_ablation_{i+1}_positive'] = None
                                ###
                        ...
                        for a_model in ablation_models:
                            ...
                            metric_results[a_model + f'_{ablation_data}_MSE_before_ablation_positive'] = mean_squared_error(y_data, y_pred)
                            metric_results[a_model + f'_{ablation_data}_R_2_before_ablation_positive'] = r2_score(y_data, y_pred)
                            ###
                            ...
                            for i in range(num_ablate_features):
                                metric_results[f'{a_model}_{ablation_data}_MSE_after_ablation_{i+1}_positive'] = ablation_results_list[i]
                                metric_results[f'{a_model}_{ablation_data}_R_2_after_ablation_{i+1}_positive'] = ablation_results_list_r2[i]
                                ###
                ...
                for ablation_data in ablation_datas:
                    ...
                    if not isinstance(local_fi_score_data, np.ndarray):
                        for a_model in ablation_models:
                            metric_results[a_model + f'_{ablation_data}_MSE_before_ablation_negative'] = None
                            metric_results[a_model + f'_{ablation_data}_R_2_before_ablation_negative'] = None
                            ###
                            metric_results[a_model + f'_{ablation_data}_mean_y_pred_before_ablation_negative'] = None
                            ###
                        for i in range(num_ablate_features):
                            for a_model in ablation_models:
                                metric_results[f'{a_model}_{ablation_data}_MSE_after_ablation_{i+1}_negative'] = None
                                metric_results[f'{a_model}_{ablation_data}_R_2_after_ablation_{i+1}_negative'] = None
                                ###
                        ...
                        for a_model in ablation_models:
                            ...
                            ablation_est = ablation_models[a_model]
                            y_pred = ablation_est.predict(X_data)
                            metric_results[a_model + f'_{ablation_data}_MSE_before_ablation_negative'] = mean_squared_error(y_data, y_pred)
                            metric_results[a_model + f'_{ablation_data}_R_2_before_ablation_negative'] = r2_score(y_data, y_pred)
                            ###
                            ...
                            for i in range(num_ablate_features):
                                ...
                                X_temp = ablation_X_data
                            for i in range(num_ablate_features):
                                metric_results[f'{a_model}_{ablation_data}_MSE_after_ablation_{i+1}_negative'] = ablation_results_list[i]
                                metric_results[f'{a_model}_{ablation_data}_R_2_after_ablation_{i+1}_negative'] = ablation_results_list_r2[i]
                                ###
