...
def rbo_dict(dict1, dict2, p, *, sort_ascending_dict1=False, sort_ascending_dict2=False, verbose=False):
    ...
    """
    list1, list2 = (
        sort_dict(dict1, ascending=sort_ascending_dict1),
        sort_dict(dict2, ascending=sort_ascending_dict2),
    )
    if verbose:
        print(list1, list2)
