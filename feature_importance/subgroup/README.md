...
To reproduce the results in Section 8 and Appendix I:
...
- Still in `compile-results`, run the `case-study.ipynb` notebook, producing the figures displayed in both Section 8 and Appendix I.